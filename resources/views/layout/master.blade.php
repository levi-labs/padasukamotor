...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center d-print-none">
        ...
        <nav class="header-nav ms-auto">
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3 d-print-none">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        <li class="dropdown-header">
                            ...
                            <span>{{ auth()->user()->akses_user }}</span>
                        </li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
    ...
    <!-- ======= Footer ======= -->
    {{-- <footer id="footer" class="footer d-print-none fixed-bottom">
        <div class="copyright">
    ...
    {{-- Designed by <a href="https://bootstraps.com/">Bootstrap</a> --}}
    {{-- </div>
    </footer><!-- End Footer --> --}}
